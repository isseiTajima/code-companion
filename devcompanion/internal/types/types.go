...
const (
	...
	StyleCool      PersonaStyle = "cool"
	StyleOneesan   PersonaStyle = "oneesan"
)
...
const (
	...
	InitWeather     InitiativeType = "weather"
)
...
type TraitProgress struct {
	...
	LastUpdated  string    `json:"last_updated"` // 回答時刻（鮮度管理）
	LastAsked    string    `json:"last_asked"`   // 質問発火時刻（スキップ時も記録）
}
